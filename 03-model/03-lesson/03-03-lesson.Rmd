...
pacman::p_load(knitr, learnr, tidyverse, openintro, grid, png, emo, ggplot2)
...
<div id="ex2-hint">
**Hint:** Input your best guess for the slope of the regression line between height and weight. 
</div>
