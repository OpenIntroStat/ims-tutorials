...
```{r ex01, echo=TRUE, exercise=TRUE}
...
```{r dataspace-setup, echo=TRUE, exercise=TRUE}
data_space <- ggplot(babies, aes(x = gestation, y = age)) + 
  geom_point(aes(color = bwt))  
data_space
```

You may note in the resulting graph that the blue points tend to get lighter with increasing gestation, reflecting an increase in birthweight.
...
```{r babies-tiled-plane, echo=TRUE, exercise=TRUE}
