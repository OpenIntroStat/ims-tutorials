...
Observations in each sample should be independent of each other. We discussed earlier that this is a difficult condition to check, especially if the study didn't employ random sampling. Fortunately, American Community Survey employs random sampling, so it seems reasonable to infer that the observations in the sample are independent. 
