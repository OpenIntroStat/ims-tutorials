...
<<<<<<< HEAD
```{r bootstrap_percentile_setup, echo=FALSE}
one_poll <- all_polls %>%
  filter(poll == 1) %>%
=======
...
```{r bootstrap_percentile, exercise=TRUE, exercise.setup="bootstrap_percentile_setup"}
...
```{r bootstrap_percentile_2, exercise=TRUE, exercise.setup="bootstrap_percentile_setup"}
# From previous step
one_poll_boot |>
  summarize(
    lower = quantile(stat, 0.025),
...
```{r bootstrap_percentile_3, exercise=TRUE, exercise.setup="bootstrap_percentile_setup"}
# From previous step
percentile_ci <- one_poll_boot |> 
  get_confidence_interval(level = 0.95)
