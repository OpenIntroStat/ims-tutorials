...
```{r doctor_4, exercise=TRUE, exercise.setup="doctor_setup"}
...
```{r doctor_5, exercise=TRUE, exercise.setup="doctor_setup"}
# From previous step
visit_sd_ci <- ncbirths_complete_visits |>
  specify(response = visits) |>
  generate(reps = 15000, type = "bootstrap") |>
...
```{r apartments_4_setup, echo=FALSE}
# Set seed so that same bootstrap sample can be reused later
set.seed(20170802)
# From previous step
n_replicates <- 15000
