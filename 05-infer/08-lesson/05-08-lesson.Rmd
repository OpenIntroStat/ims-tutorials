...
You have successfully completed Lesson 4 in Tutorial 5: Comparing many means.  
...
`r emo::ji("two")` [Tutorial 5 - Lesson 2: Introducing the t-distribution](https://openintro.shinyapps.io/ims-05-infer-02/)

`r emo::ji("three")` [Tutorial 5 - Lesson 3: Inference for difference in two parameters](https://openintro.shinyapps.io/ims-05-infer-03/)

`r emo::ji("four")` [Tutorial 5 - Lesson 4: Comparing many means](https://openintro.shinyapps.io/ims-05-infer-04/)
