...
### 5 - [Bootstrapping for estimating a parameter](https://openintro.shinyapps.io/ims-07-inference-for-numerical-responses-01/)
...
### 6 - [Introducing the t-distribution](https://openintro.shinyapps.io/ims-07-inference-for-numerical-responses-02/)

Introduce the t-distribution for theoretical inference on means and constrast it to the normal distribution. 

### 7 - [Inference for difference in two means](https://openintro.shinyapps.io/ims-07-inference-for-numerical-responses-03/)

Use simulation based and theoretical methods for inference in the difference of two means. 

### 8 - [Comparing many means](https://openintro.shinyapps.io/ims-07-inference-for-numerical-responses-04/)
