...
The population proportion is represented by the p in the cloud and the dotted line and each confidence interval is represented by a segment that extends out from its p-hat. Intervals that capture the true value are in green; those that miss it are in red.
