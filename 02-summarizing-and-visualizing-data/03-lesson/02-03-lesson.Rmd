...
2. Use `mutate()` to create a new variable called `is_outlier` to identify countries with a life expectancy less than 50
3. Use `filter()` again to exclude all outliers
...
```{r ex5-hint-2}
## Next, create a new variable named is_outlier for countries with a life expectancy less than 50
gap2007 %>% 
  filter(country == "Asia") %>%
