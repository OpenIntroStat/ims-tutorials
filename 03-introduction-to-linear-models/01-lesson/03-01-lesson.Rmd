...
This type of dotplot is not standard. What is more common is to create side-by-side boxplots of the distribution of these points. If we change from `geom_point()` to `gome_boxplot()`, we will get this more "standard" visualization.
...
1. Create a new dataset named `at_gt_200` which contains only the players who had at least 200 at-bats.
