...
quiz(
  question("What can we conclude based on the p-value associated with the twins data?",
           correct = "A p-value is the probability of seeing data this (or more) extreme, given the null hypothesis is true.", 
           allow_retry = TRUE,
    answer("A biological twin's IQ being higher causes a foster twin's IQ to be higher.", message = "Rememeber that a p-value is the probability of seeing data this (or more) extreme, given the null hypothesis is true."),
    answer("If there were no association between foster and biological twin IQ (no nature) in the population, we would be extremely unlikely to have collected a sample of data like we did. ", correct=TRUE),
    answer("Biological twins' IQs are higher than foster twins' IQs, on average.", message = "Rememeber that a p-value is the probability of seeing data this (or more) extreme, given the null hypothesis is true."),
    answer("Given the data, the probability of biological and foster twins' IQs being unrelated is close to zero.", message = "Rememeber that a p-value is the probability of seeing data this (or more) extreme, given the null hypothesis is true.")
  ), caption = ""
)
```
...
```{r ex210_setup, echo=FALSE, eval=FALSE}
set.seed(4747)
boot_slope <- twins %>%
  specify(Foster ~ Biological) %>%
  generate(reps = 1000, type = "bootstrap") %>%
...
```{r ex210, exercise=TRUE, exercise.setup="ex210_setup"}
# Set alpha
alpha <- ___
...
quiz(
  question("What are the appropriate conclusions of this study?",
           correct = "A p-value is the probability of seeing data this (or more) extreme, given the null hypothesis is true.", 
           allow_retry = TRUE,
    answer("Zero is not a plausible value for the estimated slope, one is a plausible value for the estimated slope.", message = "Remember the difference between the population slope and the estimated slope. What do the inferential procedures you've performed say about each one?"),
    answer("Zero is a plausible value for the population slope, one is not a plausible value for the population slope.", message = "Remember the difference between the population slope and the estimated slope. What do the inferential procedures you've performed say about each one?"),
    answer("Zero is not a plausible value for the population slope, one is a plausible value for the population slope.", correct=TRUE),
    answer("Zero is a plausible value for the estimated slope, one not is a plausible value for the estimated slope.", message = "Remember the difference between the population slope and the estimated slope. What do the inferential procedures you've performed say about each one?")
  ), caption = ""
)
```
