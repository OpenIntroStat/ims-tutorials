...
```{r popdata_setup, echo=FALSE, message=FALSE, warning=FALSE}
set.seed(4747)
...
```{r ex11, exercise=TRUE, exercise.setup="popdata_setup"}
...
```{r ex12, exercise=TRUE, exercise.setup="popdata_setup"}
...
```{r ex13, exercise=TRUE, exercise.setup="popdata_setup"}
# From previous step
set.seed(4747)
...
```{r ex14, exercise=TRUE, exercise.setup="popdata_setup"}
...
```{r ex15, exercise=TRUE, exercise.setup="popdata_setup"}
# From previous step
set.seed(4747)
...
```{r ex16, exercise=TRUE, exercise.setup="popdata_setup"}
# From previous step
set.seed(4747)
many_samples <- popdata |> rep_sample_n(size = 50, reps = 100)
...
```{r ex17, exercise=TRUE, exercise.setup="popdata_setup"}
# From previous steps
set.seed(4747)
many_samples <- popdata |> rep_sample_n(size = 50, reps = 100)
many_lms <- many_samples |> 
...
```{r ex17-s, exercise=TRUE, exercise.setup="popdata_setup"}
set.seed(4747)
...
```{r ex18, exercise=TRUE, exercise.setup="popdata_setup"}
set.seed(4747)
...
```{r ex19_setup, echo=FALSE, message=FALSE, warning=FALSE}
set.seed(4747)
explanatory <- rnorm(1000, 0, 5)
response <- 40 + explanatory*2 + rnorm(1000,0,10)
popdata <- data.frame(explanatory,response)
...
```{r ex19, exercise=TRUE, exercise.setup="ex19_setup"}
...
```{r ex110_setup, echo=FALSE, message=FALSE, warning=FALSE}
set.seed(4747)
explanatory <- rnorm(1000, 0, 5)
response <- 40 + explanatory*2 + rnorm(1000,0,10)
popdata <- data.frame(explanatory,response)
...
```{r ex110, exercise=TRUE, exercise.setup="ex110_setup"}
...
```{r quiz_1}
quiz(
  question("The last three exercises have demonstrated how the variability in the slope coefficient can change based on changes to the population and the sample.  Which of the following combinations *increases* the variability in the sampling distribution of the slope coefficient?",
           correct = "More variability in the response and less variability in the explanatory variable *both* increase the variability of the slope coefficient.", 
           allow_retry = TRUE,
    answer("Bigger sample size, larger variability around the line, increased range of explanatory variable.", message = "Recall the more variability in the response and less variability in the explanatory variable *both* increase the variability of the slope coefficient."),
    answer("Smaller sample size, larger variability around the line, decreased range of explanatory variable.", correct=TRUE),
    answer("Bigger sample size, larger variability around the line, decreased range of explanatory variable.", message = "Recall the more variability in the response and less variability in the explanatory variable *both* increase the variability of the slope coefficient."),
    answer("Smaller sample size, smaller variability around the line, increased range of explanatory variable.", message = "Recall the more variability in the response and less variability in the explanatory variable *both* increase the variability of the slope coefficient."),
    answer("Smaller sample size, smaller variability around the line, decreased range of explanatory variable.", message = "Recall the more variability in the response and less variability in the explanatory variable *both* increase the variability of the slope coefficient.")
  ), caption = ""
)
```
