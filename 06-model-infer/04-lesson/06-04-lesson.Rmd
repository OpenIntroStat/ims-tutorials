...
```{r ex41_setup, echo=FALSE, message=FALSE, warning=FALSE}
set.seed(4747)
...
```{r ex41, exercise=TRUE, exercise.setup="ex41_setup"}
...
```{r ex42, exercise=TRUE, exercise.setup="ex41_setup"}
...
```{r hypdata_poor_setup, echo=FALSE}
set.seed(4747)
...
```{r ex43, exercise=TRUE, exercise.setup="hypdata_poor_setup"}
...
```{r ex45, exercise=TRUE, exercise.setup="hypdata_poor_setup"}
# Run a linear regression of response vs. explanatory
model <- ___
...
```{r hypdata_outlier_setup, echo=FALSE, message=FALSE, warning=FALSE}
set.seed(4747)
...
```{r ex44, exercise=TRUE, exercise.setup="hypdata_outlier_setup"}
# This plot is shown
...
<<<<<<< HEAD
```{r exer45, exercise=TRUE, exercise.setup="hypdata_outlier_setup"}
=======
```{r echo=FALSE, message=FALSE, warning=FALSE}
set.seed(4747)
hypdata_outlier <- tibble(explanatory = rnorm(200, 3, 1), response = explanatory * 3 + 12 + rnorm(200, 0, 2))
...
```{r ex46_setup, echo=FALSE, message=FALSE, warning=FALSE}
set.seed(4747)
...
```{r ex46, exercise=TRUE, exercise.setup="ex46_setup"}
...
```{r ex47_setup, echo=FALSE, message=FALSE, warning=FALSE}
n <- 100
set.seed(4747)
...
```{r ex47, exercise=TRUE, exercise.setup="ex47_setup"}
...
```{r ex48, exercise=TRUE, exercise.setup="ex47_setup"}
# Run this to see how the model looks
...
# Using modeled_observations, plot residuals vs. fitted values
ggplot(modeled_observations, aes(x = .fitted, y = .std.resid)) +
  # Add a point layer
  geom_point() + 
  # Add horizontal line at y = 0
  geom_hline(yintercept = 0)
...
```{r hypdata_nonnorm_setup, echo=FALSE, message=FALSE, warning=FALSE}
n <- 100
set.seed(4747)
...
```{r ex411, exercise=TRUE, exercise.setup="hypdata_nonnorm_setup"}
# Run this to see how the model looks
...
```{r ex412, exercise=TRUE, exercise.setup="hypdata_nonnorm_setup"}
# Run this to see how the model looks
